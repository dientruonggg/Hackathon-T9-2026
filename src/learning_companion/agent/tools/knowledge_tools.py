...
def get_learner_profile(user_id: str) -> str:
    ...
    print('🟡 CALLED: agent/tools/knowledge_tools.py -> get_learner_profile')
...
def set_learner_profile(user_id: str, goal: str) -> str:
    ...
    print('🟡 CALLED: agent/tools/knowledge_tools.py -> set_learner_profile')
...
def get_knowledge_state(user_id: str, concept: str) -> str:
    ...
    print('🟡 CALLED: agent/tools/knowledge_tools.py -> get_knowledge_state')
...
def set_knowledge_state(user_id: str, concept: str, mastery_level: int) -> str:
    ...
    print('🟡 CALLED: agent/tools/knowledge_tools.py -> set_knowledge_state')
